...
// Source: svgs/nature/hop-off.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const HopOffMeta: IconMeta = {
  name: 'hop-off',
  category: 'nature',
  tags: [],
  version: '0.1.0',
...
export const HopOffIcon = forwardRef<SVGSVGElement, IconProps>(function HopOffIcon(props, ref) {
  return (
    <Icon ref={ref} {...props}>
