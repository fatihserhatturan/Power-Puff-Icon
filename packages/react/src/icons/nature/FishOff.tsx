...
// Source: svgs/nature/fish-off.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const FishOffMeta: IconMeta = {
  name: 'fish-off',
  category: 'nature',
  tags: [],
  version: '0.1.0',
...
export const FishOffIcon = forwardRef<SVGSVGElement, IconProps>(function FishOffIcon(props, ref) {
  return (
    <Icon ref={ref} {...props}>
