...
// Source: svgs/text/soap-dispenser-droplet.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const SoapDispenserDropletMeta: IconMeta = {
...
export const SoapDispenserDropletIcon = forwardRef<SVGSVGElement, IconProps>(
  function SoapDispenserDropletIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
        <path d="M10.5 2v4" />
