...
// Source: svgs/social/heart-off.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const HeartOffMeta: IconMeta = {
  name: 'heart-off',
  category: 'social',
  tags: [],
  version: '0.1.0',
...
export const HeartOffIcon = forwardRef<SVGSVGElement, IconProps>(function HeartOffIcon(props, ref) {
  return (
    <Icon ref={ref} {...props}>
