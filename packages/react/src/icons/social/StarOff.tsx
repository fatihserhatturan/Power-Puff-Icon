...
// Source: svgs/social/star-off.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const StarOffMeta: IconMeta = {
  name: 'star-off',
  category: 'social',
  tags: [],
  version: '0.1.0',
...
export const StarOffIcon = forwardRef<SVGSVGElement, IconProps>(function StarOffIcon(props, ref) {
  return (
    <Icon ref={ref} {...props}>
