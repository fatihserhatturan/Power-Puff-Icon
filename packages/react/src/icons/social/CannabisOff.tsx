...
// Source: svgs/social/cannabis-off.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const CannabisOffMeta: IconMeta = {
  name: 'cannabis-off',
  category: 'social',
  tags: [],
  version: '0.1.0',
...
export const CannabisOffIcon = forwardRef<SVGSVGElement, IconProps>(
  function CannabisOffIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
