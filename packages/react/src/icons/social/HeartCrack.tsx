...
// Source: svgs/social/heart-crack.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const HeartCrackMeta: IconMeta = {
  name: 'heart-crack',
  category: 'social',
  tags: [],
  version: '0.1.0',
...
export const HeartCrackIcon = forwardRef<SVGSVGElement, IconProps>(
  function HeartCrackIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
