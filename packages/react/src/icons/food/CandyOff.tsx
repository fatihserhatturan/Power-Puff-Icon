...
// Source: svgs/food/candy-off.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const CandyOffMeta: IconMeta = {
  name: 'candy-off',
  category: 'food',
  tags: [],
  version: '0.1.0',
...
export const CandyOffIcon = forwardRef<SVGSVGElement, IconProps>(function CandyOffIcon(props, ref) {
  return (
    <Icon ref={ref} {...props}>
      <path d="M10 10v7.9" />
