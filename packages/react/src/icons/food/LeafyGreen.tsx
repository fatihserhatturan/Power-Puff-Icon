...
// Source: svgs/food/leafy-green.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const LeafyGreenMeta: IconMeta = {
  name: 'leafy-green',
  category: 'food',
  tags: [],
  version: '0.1.0',
...
export const LeafyGreenIcon = forwardRef<SVGSVGElement, IconProps>(
  function LeafyGreenIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
