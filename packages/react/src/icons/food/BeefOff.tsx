...
// Source: svgs/food/beef-off.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const BeefOffMeta: IconMeta = {
  name: 'beef-off',
  category: 'food',
  tags: [],
  version: '0.1.0',
...
export const BeefOffIcon = forwardRef<SVGSVGElement, IconProps>(function BeefOffIcon(props, ref) {
  return (
    <Icon ref={ref} {...props}>
