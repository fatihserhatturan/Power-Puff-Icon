...
// Source: svgs/security/shield-cog-corner.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const ShieldCogCornerMeta: IconMeta = {
...
export const ShieldCogCornerIcon = forwardRef<SVGSVGElement, IconProps>(
  function ShieldCogCornerIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
