...
// Source: svgs/security/shield-cog.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const ShieldCogMeta: IconMeta = {
  name: 'shield-cog',
  category: 'security',
  tags: [],
  version: '0.1.0',
...
export const ShieldCogIcon = forwardRef<SVGSVGElement, IconProps>(
  function ShieldCogIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
