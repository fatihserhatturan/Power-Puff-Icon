...
// Source: svgs/files/file-heart.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const FileHeartMeta: IconMeta = {
  name: 'file-heart',
  category: 'files',
  tags: [],
  version: '0.1.0',
...
export const FileHeartIcon = forwardRef<SVGSVGElement, IconProps>(
  function FileHeartIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
