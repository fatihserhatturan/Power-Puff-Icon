...
// Source: svgs/files/folder-pen.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const FolderPenMeta: IconMeta = {
  name: 'folder-pen',
  category: 'files',
  tags: [],
  version: '0.1.0',
...
export const FolderPenIcon = forwardRef<SVGSVGElement, IconProps>(
  function FolderPenIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
