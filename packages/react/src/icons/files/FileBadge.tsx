...
// Source: svgs/files/file-badge.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const FileBadgeMeta: IconMeta = {
  name: 'file-badge',
  category: 'files',
  tags: [],
  version: '0.1.0',
...
export const FileBadgeIcon = forwardRef<SVGSVGElement, IconProps>(
  function FileBadgeIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
