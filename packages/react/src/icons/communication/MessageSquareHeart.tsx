...
// Source: svgs/communication/message-square-heart.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const MessageSquareHeartMeta: IconMeta = {
...
export const MessageSquareHeartIcon = forwardRef<SVGSVGElement, IconProps>(
  function MessageSquareHeartIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
