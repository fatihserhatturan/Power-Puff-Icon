...
// Source: svgs/gaming/gamepad-directional.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const GamepadDirectionalMeta: IconMeta = {
...
export const GamepadDirectionalIcon = forwardRef<SVGSVGElement, IconProps>(
  function GamepadDirectionalIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
