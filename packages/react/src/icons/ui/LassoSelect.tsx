...
// Source: svgs/ui/lasso-select.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const LassoSelectMeta: IconMeta = {
  name: 'lasso-select',
  category: 'ui',
  tags: [],
  version: '0.1.0',
...
export const LassoSelectIcon = forwardRef<SVGSVGElement, IconProps>(
  function LassoSelectIcon(props, ref) {
    return (
      <Icon ref={ref} {...props}>
